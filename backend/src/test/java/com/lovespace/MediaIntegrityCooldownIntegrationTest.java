...
@ActiveProfiles("test")
class MediaIntegrityCooldownIntegrationTest {
    ...
    static void enableScanCooldown(DynamicPropertyRegistry registry) {
        registry.add("app.media-integrity.scan-cooldown-seconds", () -> "60");
    }
    ...
    @Test
    void rejectsRepeatedScansWithinCooldownWindow() throws Exception {
